...
class CheckoutRepoImpl implements CheckoutRepo{
  ...
  Future<ApiResult<CashCheckoutEntity>> cashCheckout(PlaceOrderRequestEntity placeOrderRequestEntity) async {
   ...
   PlaceOrderRequestModel placeOrderRequestModel = placeOrderRequestEntity.toData();
   return await executeApi<CashCheckoutEntity>(apiCall: () async{
       var response = await _checkoutOnlineDataSource.cashCheckout(token, placeOrderRequestModel);
