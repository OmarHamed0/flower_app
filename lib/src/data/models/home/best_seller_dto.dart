...
class BestSellerDto {
  ...
  BestSellerModel toModel(BestSellerDto bestSellerDto) {
    return BestSellerModel(
      id: bestSellerDto.id,
      title: bestSellerDto.title,
      slug: bestSellerDto.slug,
      description: bestSellerDto.description,
      imgCover: bestSellerDto.imgCover,
      images: bestSellerDto.images,
      price: bestSellerDto.price,
      priceAfterDiscount: bestSellerDto.priceAfterDiscount,
      quantity: bestSellerDto.quantity,
      category: bestSellerDto.category,
      occasion: bestSellerDto.occasion,
      createdAt: bestSellerDto.createdAt,
      updatedAt: bestSellerDto.updatedAt,
      v: bestSellerDto.v,
    );
  }
}
