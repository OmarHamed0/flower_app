class ErrorMassage {
  static const String badCertificateMessage =
      "A security error has occurred. Invalid certificate.";
  ...
  static const String conflictMessage =
      "A conflict has occurred with the server.";
  ...
  static const String tokenNotProvided = "token not provided";
  static const String jsonWebTokenErrorInvalidToken =
      "JsonWebTokenError: invalid token";
  static const String invalidTokenMassage =
      "Sorry, you do not have the necessary permissions. Please log in again to continue";
  static const String invalidTokenLoginAgain = "invalid token .. login again";
}
