...
abstract class ApiServices {
  ...
  Future<ForgetPasswordResponseDto> forgetPassword(@Body() ForgetPasswordRequestDto requestBody);

  @POST(ApisEndPoints.verifyRestCodeEndPoint)
  Future<VerifyResetCodeResponseDto> verifyResetCode(@Body() String resetCode);
